...
export const env = createEnv({
  server: {
    ...
    XFYUN_HTTP_API_KEY: z.string().min(1).optional(),
    XFYUN_API_KEY: z.string().min(1).optional(),
    XFYUN_API_SECRET: z.string().min(1).optional(),
    XFYUN_APP_ID: z.string().min(1).optional(),
    DEEPSEEK_API_KEY: z.string().min(1).optional(),
  },
  client: {
    NEXT_PUBLIC_APP_URL: z.string().min(1).default('https://zhuangmei.rayvin19901110.workers.dev'),
  ...
  runtimeEnv: {
    ...
    XFYUN_HTTP_API_KEY: process.env.XFYUN_HTTP_API_KEY,
