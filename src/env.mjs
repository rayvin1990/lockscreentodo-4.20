...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_LEMON_SQUEEZY_YEARLY_URL: z.string().optional(),
    NEXT_PUBLIC_LEMON_SQUEEZY_LIFETIME_URL: z.string().optional(),
    NEXT_PUBLIC_LEMON_SQUEEZY_MONTHLY_VARIANT_ID: z.string().optional(),
    NEXT_PUBLIC_LEMON_SQUEEZY_YEARLY_VARIANT_ID: z.string().optional(),
  },
  runtimeEnv: {
    ...
    NEXT_PUBLIC_LEMON_SQUEEZY_YEARLY_URL: process.env.NEXT_PUBLIC_LEMON_SQUEEZY_YEARLY_URL,
    NEXT_PUBLIC_LEMON_SQUEEZY_LIFETIME_URL: process.env.NEXT_PUBLIC_LEMON_SQUEEZY_LIFETIME_URL,
    NEXT_PUBLIC_LEMON_SQUEEZY_MONTHLY_VARIANT_ID: process.env.NEXT_PUBLIC_LEMON_SQUEEZY_MONTHLY_VARIANT_ID,
    NEXT_PUBLIC_LEMON_SQUEEZY_YEARLY_VARIANT_ID: process.env.NEXT_PUBLIC_LEMON_SQUEEZY_YEARLY_VARIANT_ID,
